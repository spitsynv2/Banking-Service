...
import com.solvd.bankingservice.repo.IEmployeeDAO;
 ...
 * @created 2025-02-04
 */
public class EmployeeMySQLJdbcImpl extends AbstractMySQLJdbcImpl<Employee,Long> implements IEmployeeDAO {

    private static final Logger log = LogManager.getLogger(EmployeeMySQLJdbcImpl.class);
    ...
    protected String getForeignKeyColumnLabel() {
        log.error("Method getForeignKeyColumnLabel() is not supported in EmployeeMySQLJdbcImpl");
        return null;
    }

    @Override
    public List<Employee> readAllByForeignKeyId(Long foreignKeyId) {
        log.error("Method readAllByForeignKeyId is not supported in EmployeeMySQLJdbcImpl");
        return null;
    }
