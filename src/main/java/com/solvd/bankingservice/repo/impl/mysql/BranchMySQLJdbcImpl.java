 ...
 * @created 2025-02-03
 */
public class BranchMySQLJdbcImpl extends AbstractMySQLJdbcImpl<Branch,Long> implements IBranchDAO {

    private static final Logger log = LogManager.getLogger(BranchMySQLJdbcImpl.class);
