...
import com.solvd.bankingservice.repo.IAddressDAO;
 ...
 * @created 2025-01-29
 */
public class AddressMySQLJdbcImpl extends AbstractMySQLJdbcImpl<Address,Long> implements IAddressDAO {

    private static final Logger log = LogManager.getLogger(AddressMySQLJdbcImpl.class);
    ...
    public void create(Address entity) {
        log.error("Method is not implemented in AddressMySQLJdbcImpl, Use ---> createWithCustomerId");
    }
