...
import com.solvd.bankingservice.repo.ICustomerRepresentativeDAO;
 ...
 * @created 2025-01-29
 */
public class CustomerRepresentativeMySQLJdbcImpl extends AbstractMySQLJdbcImpl<CustomerRepresentative, Long> implements ICustomerRepresentativeDAO {

    private static final Logger log = LogManager.getLogger(CustomerRepresentativeMySQLJdbcImpl.class);
    ...
    public void create(CustomerRepresentative entity) {
        log.error("Method is not implemented in CustomerRepresentativeMySQLJdbcImpl, Use ---> createWithCompanyId");
    }
