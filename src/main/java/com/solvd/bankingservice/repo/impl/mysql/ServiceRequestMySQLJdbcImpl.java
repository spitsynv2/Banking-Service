 ...
 * @created 2025-02-04
 */
public class ServiceRequestMySQLJdbcImpl extends AbstractMySQLJdbcImpl<ServiceRequest,Long> implements IServiceRequestDAO {

    private static final Logger log = LogManager.getLogger(ServiceRequestMySQLJdbcImpl.class);
    ...
    public void create(ServiceRequest entity) {
        log.error("Method is not implemented in ServiceRequestMySQLJdbcImpl, Use ---> createWithCustomerId");
    }
