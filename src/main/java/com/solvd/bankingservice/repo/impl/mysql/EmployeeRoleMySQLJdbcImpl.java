...
import com.solvd.bankingservice.repo.IEmployeeRoleDAO;
import com.solvd.bankingservice.model.employee.EmployeeRole;
 ...
 * @created 2025-02-04
 */
public class EmployeeRoleMySQLJdbcImpl extends AbstractMySQLJdbcImpl<EmployeeRole,Long> implements IEmployeeRoleDAO {

    private static final Logger log = LogManager.getLogger(EmployeeRoleMySQLJdbcImpl.class);
